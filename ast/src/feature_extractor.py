...
os.environ['TORCH_HOME'] = '/opt/gpfs/home/chushu/torchhome'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_path',
                        ...
                        default='/opt/gpfs/home/chushu/data/features/ast_features',
                        type=str)
    ...
    feature_loader = DataLoader(feature_extractor, batch_size=batch_size, shuffle=False, num_workers=16, drop_last=False, collate_fn=feature_extractor.collate_fn)
    error_count = 0
