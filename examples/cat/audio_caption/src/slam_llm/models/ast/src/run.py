...
parser.add_argument("--disp_loss_weight", type=float, default=0.0, help="disp loss weight")
parser.add_argument("--disp_loss_layer", type=int, default=12, help="disp loss weight")
parser.add_argument("--disp_loss_cls", type=bool, default=True, help="disp loss weight")
