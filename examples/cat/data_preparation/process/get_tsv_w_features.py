...
def match_files(wav_files: List[Tuple[str, int]], clap_files: Dict[str, str], mel_files: Dict[str, str],
    ...
    for relative_path, frame_size in wav_files:
        ...
        if wav_basename in clap_files and (wav_basename in mel_files or mel_files == ''):
            # Both wav and CLAP exist
            dict = {
                "wav_path": os.path.join(common_path, relative_path),
                "clap_path": clap_files[wav_basename],
                "mel_path": mel_files[wav_basename] if wav_basename in mel_files else '',
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_path', 
                       default='/inspire/hdd/global_user/zhouchushu-253108120180/data/audioset/meta_w_feature/unbal_train_dasheng.json',
