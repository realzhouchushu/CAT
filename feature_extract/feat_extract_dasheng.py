...
class DashengFeatureExtractor(Dataset):
    def __init__(self, audio_path, model_path):
        ...
        self.feature_extractor = AutoFeatureExtractor.from_pretrained(checkpoint_path, trust_remote_code=True)
        self.audio_model = AutoModel.from_pretrained(checkpoint_path, outputdim=None, trust_remote_code=True)
    ...
    def collate_fn(self, batch):
        ...
        feats = self.feature_extractor(feats, sampling_rate=16000, return_tensors="pt")
    ...
    def extract_features(self, feats):
        self.audio_model.eval()
        with torch.no_grad():
            outputs = self.audio_model(**feats)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_path", type=str,
                        ...
                        default='./pretrained_models/dasheng-base',
                        help="the trained model you want to test")
    ...
    parser.add_argument('--output_path',
                        ...
                        default="/inspire/hdd/global_user/zhouchushu-253108120180/raw_datas/features/audioset/dasheng_features",
                        type=str)

    args = parser.parse_args()
    
    batch_size = 64
    feature_extractor = DashengFeatureExtractor(args.audio_path, args.model_path)
