...
split=train
python /opt/gpfs/home/chushu/codes/2506/fairseq/examples/wav2vec/libri_labels.py /opt/gpfs/home/chushu/data/librispeech/${split}.tsv --output-dir /opt/gpfs/home/chushu/data/librispeech --output-name $split